...
import cap6 from "../assets/certs/cap6.png"
    ...
    return (
        <div id="certs" className="mt-4 text-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 justify-center mt-4 gap-5">
                ...
                <CertCard name="CarSales un site vitrine pour un vendeur automobile (fictif), on n'y trouve du HTML, du CSS et du Javascript" img={cap6} date="Décembre 2023" />
